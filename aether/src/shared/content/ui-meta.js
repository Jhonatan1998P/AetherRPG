...
export const VIEW_META = {
  ...
  habilidades: { label: 'Habilidades', short: 'Combate activo', desc: 'Vista dedicada para gestionar habilidades: equipar, mejorar y entender uso, recarga y efectos de cada una.', icon: 'bolt' },
...
export const VIEW_GROUPS = [
  ...
  { title: 'Progreso', views: ['gremio', 'entrenamiento', 'habilidades', 'mascota', 'logros'] },
