export const SYSTEM_ACTION_REGIONS = {
  ...
  craftItem: ['hud', 'content'],
  upgradeEquipped: ['hud', 'content'],
  enhanceItem: ['hud', 'content'],
  rerollItem: ['hud', 'content'],
  reforgeItem: ['hud', 'content'],
  transcendItem: ['hud', 'content'],
  stabilizeItem: ['hud', 'content'],
  convertMaterials: ['hud', 'content'],
  setForgeSchool: ['hud', 'content'],
  unlockForgeMastery: ['hud', 'content'],
